...
public class BatchConfig
{
    ...
    private String[] format = new String[]{"employeeId","firstName","lastName","email","jobTitle","companyId"};
    ...
    {
        return stepBuilderFactory.get("orderStep1").<EmployeeDto, EmployeeDto> chunk(100)
